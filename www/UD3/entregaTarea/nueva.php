        ...
        <div class="container">
          <?php
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
              ...
              if (campoValido($titulo) && campoValido($descripcion) && campoValido($estado) && campoValido($id_usuario)) {
                if (nuevaTarea($titulo, $descripcion, $estado, $id_usuario)) {
                  echo '<div class="alert alert-success" role="alert">Tarea creada correctamente</div>';
                }
                else {
